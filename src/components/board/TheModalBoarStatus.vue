  ...
  <div class="modal">
    <div class="modal__container">
      ...
      <form @submit.prevent="submitBoard">
        ...
        <input type="text" v-model="newBoard.name" placeholder="Введите заголовок Статус" />
...
export default {
  ...
  methods: {
    ...
    try {
      ...
      if (this.isFormValid) {
        this.newBoard.id = boardId;
        const response = await this.$store.dispatch('addBoardStatus', { ...this.newBoard });
